                ...
                <div class="col-lg-12">
                  <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                      <h6 class="m-0 font-weight-bold text-primary">List Quiz</h6>
                    </div>
                        ...
                        <tbody>
                          ...
                          ?>
                            ...
                            foreach ($groupData as $quest) { ?>
                              <tr>
                                <td><a href="#">ID<?= $quest['id'] ?></a></td>
                                <td><?= $quest['nama'] ?></td>
                                <td><?= $quest['name'] ?></td>
                                <?php
                                foreach ($quest['options'] as $opsi) { ?>
                                  <td><?= $opsi ?></td>
                                <?php }
                                ?>
                                <td>
                                  <div class="d-flex">
                                    <a href="/question/edit?question=<?= $quest['id'] ?>" class="btn btn-secondary">Edit</a>
                                    <div class="p-2"></div>
